...
namespace InventoryManagement {
    ...
    public partial class InventoryDbDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(int ProductId, string ProductName, int Price, string Quantity) {
...
namespace InventoryManagement.InventoryDbDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductId], [ProductName], [Price], [Quantity]) VA" +
                "LUES (@ProductId, @ProductName, @Price, @Quantity);\r\nSELECT ProductId, ProductNa" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductId] = @ProductId, [ProductName] = @ProductName, [Price] = @Price, [Quantity] = @Quantity WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)));
SELECT ProductId, ProductName, Price, Quantity FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InventoryManagement.Properties.Settings.Default.InventoryDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, Price, Quantity FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, global::System.Nullable<int> Original_Price, string Original_Quantity) {
        ...
        public virtual int Insert(int ProductId, string ProductName, global::System.Nullable<int> Price, string Quantity) {
        ...
        public virtual int Update(int ProductId, string ProductName, global::System.Nullable<int> Price, string Quantity, int Original_ProductId, string Original_ProductName, global::System.Nullable<int> Original_Price, string Original_Quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<int> Price, string Quantity, int Original_ProductId, string Original_ProductName, global::System.Nullable<int> Original_Price, string Original_Quantity) {
            return this.Update(Original_ProductId, ProductName, Price, Quantity, Original_ProductId, Original_ProductName, Original_Price, Original_Quantity);
        }
    }
